...
@section('main')
    ...
    <div class="relative overflow-hidden min-h-screen">
        <!-- Animated background shape (always animating) -->
       ...
       <div class="">
         <section class="relative z-10 w-full py-12 md:py-24 flex flex-col md:flex-row items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            <div class="max-w-xl flex justify-center w-full md:w-auto mb-10 md:mb-0">
               <div class="sm:ml-18 md:ml-12 lg:ml-24 xl:ml-48 text-center md:text-left">
                 <h3 class="text-pink-500 font-semibold tracking-widest mb-2 text-sm md:text-md text-left
                           scroll-animate fade-in" data-delay="0.1">SOLUTIONS</h3>
           ...
           <div class="relative flex justify-center items-center w-full max-w-full sm:max-w-4xl">
                ...
                <!-- Phone & chats -->
                <div class="relative left-[90px] top-[-24px] sm:left-[220px] sm:top-[-5px] md:left-[100px] lg:left-[110px] xl:left-[120px] 2xl:left-[170px]">
                    ...
                    <div class="absolute flex items-center space-x-1 z-10 left-[-50px] sm:left-[-60px] md:left-[-70px] top-[20px] sm:top-[30px] md:top-[40px]
                               scroll-animate slide-left" data-delay="0.3">
                        <img src="{{ Storage::url('common/demo.png') }}" alt="User"
                             class="w-5 h-5 sm:w-6 sm:h-6 rounded-full border-2 border-white shadow-md">
                        <span class="bg-purple-600 text-white px-2 py-1 rounded-full shadow text-[7px] sm:text-[8px] md:text-[9px] lg:text-[11px]">You can pay me through this link</span>
                    </div>
                    ...
                    <div class="absolute flex items-center space-x-1 z-10 left-[-30px] sm:left-[-15px] md:left-[-20px] bottom-[40px] sm:bottom-[60px] md:bottom-[70px]
                               scroll-animate slide-left" data-delay="0.5">
                        <img src="{{ Storage::url('common/demo.png') }}" alt="User"
                             class="w-5 h-5 sm:w-6 sm:h-6 rounded-full border-2 border-white shadow-md">
                        <span class="bg-purple-600 text-white px-2 py-1 rounded-full shadow text-[7px] sm:text-[8px] md:text-[9px] lg:text-[11px]">Got it. Thanks</span>
                    </div>

                    <!-- Chat 3 -->
                    <div class="absolute top-1/3 right-[-30px] sm:right-[-15px] md:right-[-20px] flex items-center space-x-1 z-10
                               scroll-animate slide-right" data-delay="0.7">
                        <span class="bg-green-500 text-white px-2 py-1 rounded-full shadow text-[7px] sm:text-[8px] md:text-[9px] lg:text-[11px]">Payment sent!</span>
                        <img src="{{ Storage::url('common/demo.png') }}" alt="User"
                             class="w-5 h-5 sm:w-6 sm:h-6 rounded-full border-2 border-white shadow-md">
                    </div>
                </div>
        ...
        <div class="mt-10 md:mt-20 text-center px-4 sm:px-6 z-10 relative
                   scroll-animate fade-in" data-delay="0.5">
            ...
            <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div class="order-1 md:order-2 text-center md:text-left">
                    <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-700 mb-4 md:mb-6 font-serif
                              scroll-animate fade-in" data-delay="0.2">New Payment Type is in Town!</h2>
                    ...
                    <ol class="space-y-3 md:space-y-4 text-gray-700 list-decimal list-inside font-sans text-left mx-auto md:mx-0 max-w-md md:max-w-none">
                        <li class="flex items-start space-x-2
                                  scroll-animate fade-right" data-delay="0.4">
                        ...
                        <li class="flex items-start space-x-2
                                  scroll-animate fade-right" data-delay="0.5">
                        ...
                        <li class="flex items-start space-x-2
                                  scroll-animate fade-right" data-delay="0.6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div class="text-center md:text-left">
                    <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-700 mb-4 font-serif text-center md:text-center
                              scroll-animate fade-in" data-delay="0.2">What We Offer</h2>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                    ...
                    @foreach($features as $index => $feature)
                        <div class="bg-gray-50 p-4 sm:p-6 rounded-lg text-center hover:shadow-md transition-all duration-300 transform hover:-translate-y-1
                                    scroll-animate fade-up" data-delay="{{ ($index % 3) * 0.1 }}">
