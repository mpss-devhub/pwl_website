@extends('welcome')
@section('main')
    <div class="z-10 relative py-12 min-h-screen px-4 sm:px-6 lg:px-8 text-[#2d2c3c]"
        style="font-family: 'Poppins', sans-serif;">

        <div class="py-6 mx-auto max-w-6xl">
            <div
                class="text-left text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl
        ...
        <div class="flex flex-col items-center justify-center py-10 mx-auto max-w-5xl text-center px-4">
            <p class="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-semibold">OUR COMPANY JOURNEY</p>
            <p class="mt-8 leading-relaxed">
                ...
                enhanced approach as a FinTech enabler, “Octoverse”, starting from the year 2022 - 2023.
            </p>
        </div>
        ...
        <div class="flex flex-col lg:flex-row items-center justify-evenly py-10 gap-8 lg:gap-12 mx-auto max-w-6xl">
            ...
            <div class="text-center">
                <p class="text-xl font-semibold">All Your Payment, One Link</p>
                <p class="px-4 mt-4">
