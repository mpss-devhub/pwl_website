            ...
            <div class="grid lg:grid-cols-4 gap-6">
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow mt-3">
                        <h2 class="text-sm font-semibold text-gray-700 mb-4 text-start">Octoverse Merchant
                            <span class="ml-2 px-2 py-1 bg-green-100 text-green-700 rounded-full text-[10px]">Active</span>
                        </h2>
                        <div class="mt-6">
                ...
                <div class="lg:col-span-3 space-y-6">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow">
                        <div class="flex items-center justify-between mb-4">
                            <h2 class="text-sm font-semibold text-gray-800"><i class="fa-regular fa-circle-user mr-2"></i>
                                Basic Information</h2>
                            <span class="text-[10px] bg-blue-100 text-blue-800 px-2 py-1 rounded">User ID :
                    ...
                    <div class="bg-white p-6 rounded-lg shadow">
                        <h2 class="text-sm font-semibold text-gray-800 mb-4"> <i
                    ...
                    <div class="bg-white p-6 rounded-lg shadow mt-4">
                        <div class="flex">
                            ...
                            <p class="block text-[12px] font-medium text-gray-700 ">( Remarks )</p>
                        </div>
                        <div class="mt-2">
                            <div>
