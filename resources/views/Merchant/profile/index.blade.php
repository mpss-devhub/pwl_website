            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <input type="file" id="file-upload" name="file-upload" accept="image/*" class="hidden">
                    ...
                    <div class="mt-6 space-y-4">
                        <div>
                            ...
                            <div class="flex items-center bg-gray-100 px-3 py-2 rounded-md">
                                <span class="text-gray-600">{{ $Merchantinfo['merchant_id'] }}</span>
            ...
            <div class="lg:col-span-3 space-y-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded">Your Information</span>
                    </div>

                    <div class="grid md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Merchant Name <span class="text-red-500">*</span></label>
                            <input value="{{ $Merchantinfo['merchant_name'] }}" type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Contact Name <span class="text-red-500">*</span></label>
                            <input value="{{ $Merchantinfo['merchant_Cname'] }}" type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Contact Phone <span class="text-red-500">*</span></label>
                            <div class="flex">

                                <input value="{{ $Merchantinfo['merchant_Cphone'] }}" type="tel" class="flex-1 px-3 py-2 border-t border-r border-b border-gray-300 rounded-r-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Contact Email <span class="text-red-500">*</span></label>
                            <input value="{{ $Merchantinfo['merchant_Cemail'] }}" type="email" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="flex">
                                ...
                                <input value="{{ $Merchantinfo['merchant_frontendURL'] }}" type="text" class="flex-1 px-3 py-2 border-t border-r border-b border-gray-300 rounded-r-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="flex">
                                ...
                                <input value="{{ $Merchantinfo['merchant_backendURL'] }}" type="text" class="flex-1 px-3 py-2 border-t border-r border-b border-gray-300 rounded-r-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="flex">
                                ...
                                <input value="{{ $Merchantinfo['merchant_address'] }}" type="text" name="merchant_address" class="flex-1 px-3 py-2 border-t border-r border-b border-gray-300 rounded-r-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Notify Email</label>
                            <input value="{{ $Merchantinfo['merchant_notifyemail'] }}" type="email" name="merchant_notifyemail" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                    </div>
                </div>
                ...
                <!-- Documents Section -->
                <div class="bg-white p-6 rounded-lg shadow">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">Merchants Documents</h2>
