               ...
               <form action="{{ route('merchant.sms') }}" method="GET">
                 <div id="filter-content" class="px-6 pb-6 hidden">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
                        ...
                        <div class="flex flex-col sm:flex-row items-stretch sm:items-end gap-2">
                            <a href="{{ route('merchant.link.csv.export',request()->query()) }}"
                                class="text-[9px] sm:text-[9px] md:text-[10px] lg:text-xs bg-gray-800 hover:bg-gray-700 text-white px-4 py-2.5 rounded-md transition-colors w-full flex items-center justify-center">

                                Export CSV
                            </a>

                            <a href="{{ route('merchant.link.excel.export',request()->query()) }}"
                                class="text-[9px] sm:text-[9px] md:text-[10px] lg:text-xs bg-green-600 hover:bg-green-700 text-white px-4 py-2.5 rounded-md transition-colors w-full flex items-center justify-center">
                                ...
                                <tr class="link-row hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-3 text-center whitespace-nowrap text-[9px] sm:text-[9px] md:text-[10px] lg:text-[11px] text-gray-500">
                                        ...
                                        @elseif ($item->link_status === 'expired')
                                            <span class="px-2 inline-flex   text-[9px] sm:text-[9px] md:text-[10px] lg:text-[11px] leading-5 font-semibold rounded-full bg-red-100 text-red-800">Expired</span>
                                        @endif
                                    </td>
                                    <td class="px-6 py-3 text-center whitespace-nowrap text-[9px] sm:text-[9px] md:text-[10px] lg:text-[11px] text-gray-500">
