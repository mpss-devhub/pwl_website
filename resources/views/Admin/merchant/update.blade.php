...
@foreach ($details as $detail)
        <form action="{{ route('merchant.update.post') }}" method="POST" enctype="multipart/form-data">
       @csrf
                  ...
                  <div class="bg-white p-6 rounded-lg shadow mt-3">
                            ...
                            <div class=" space-y-2 mt-4 ">
                                ...
                                <div class="border flex justify-center  py-2  rounded-lg hover:shadow-sm ">
                                    <a href="{{ $detail->merchant_registration }}" download class="" @disabled($detail->merchant_registration == null)>
                                ...
                                <!-- Shareholder List -->
                                <div class="border flex justify-center  py-2  rounded-lg hover:shadow-sm">
                                    <a href="{{ $detail->merchant_shareholder }}" download class="" @disabled($detail->merchant_registration == null)>
                                ...
                                <!-- DICA File -->
                                <div class="border flex justify-center  py-2  rounded-lg hover:shadow-sm">
                                    <a href="{{ $detail->merchant_dica }}" download class="" @disabled($detail->merchant_registration == null)>
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="flex">
                                ...
                                <input value="{{ $detail->merchant_frontendURL }}" type="text" name="merchant_frontendURL" class="flex-1 px-3 py-2 border-t border-r border-b border-gray-300 rounded-r-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div class="flex">
                                ...
                                <input value="{{ $detail->merchant_address }}" type="text" name="merchant_address" class="flex-1 px-3 py-2 border-t border-r border-b border-gray-300 rounded-r-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Notify Email</label>
                            <input value="{{ $detail->merchant_notifyemail }}" type="email" name="merchant_notifyemail" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                    </div>
                </div>
