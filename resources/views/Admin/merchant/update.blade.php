                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex space-x-3">
                            <button type="submit" id='btn'
                                class="px-5 py-2.5 text-sm font-medium text-white bg-gray-800 rounded-lg hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 transition-colors">
                                <i class="fas fa-save mr-2"></i>Save Merchant
                            </button>
                            <a href="{{ route('merchant.show') }}"
                                class="px-5 py-2.5 text-sm font-medium text-gray-800 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:ring-4 focus:outline-none focus:ring-gray-200 transition-colors">
                        ...
                        <div class="lg:col-span-1 space-y-6">
                            ...
                            <div class="bg-white p-6 rounded-lg shadow">
                                ...
                                <div class="flex flex-col items-center">
                                    ...
                                    <input type="file" id="file-upload" name="merchant_logo" accept="image/*"
                                        class="hidden">
                                    ...
                                    <p class="text-[11px] mt-1 text-gray-500 text-center">JPG, PNG (300 x 300 px, max 2MB)
                                    </p>
                                </div>
                        ...
                        <div class="lg:col-span-3 space-y-6">
                            ...
                            <div class="bg-white p-6 rounded-lg shadow">
                                <div class="flex items-center justify-between mb-4">
                                    ...
                                    <span class="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded">Required
                                        Fields</span>
                                </div>
                                ...
                                <div class="grid md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input required value="{{ $detail->merchant_name }}" type="text"
                                            id='name' name="merchant_name" readonly
                                    ...
                                    <div>
                                        ...
                                        <input required value="{{ $detail->merchant_Cname }}" type="text"
                                            name="merchant_Cname"
                                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    </div>
                                    <div>
                                        ...
                                        <div class="flex">
                                            ...
                                            <input required minlength="4" maxlength="12"
                                                value="{{ $detail->merchant_Cphone }}" type="tel"
                                    ...
                                    <div>
                                        ...
                                        <input required value="{{ $detail->merchant_Cemail }}" type="email"
                            ...
                            <div class="bg-white p-6 rounded-lg shadow">
                                ...
                                <div class="grid md:grid-cols-2 gap-4">
                                    <div>
                                       <div class="flex justify-between items-center mb-1">
                                        ...
                                        <div class="flex">
                                            ...
                                            <input value="{{ $detail->merchant_frontendURL }}" type="text"
                                    ...
                                    <div>
                                        ...
                                        <div class="flex">
                                            <input readonly value="{{ $detail->merchant_backendURL }}" type="text"
                                                name="merchant_backendURL"
                                                class="flex-1 px-3 py-2 border-t border-r border-b border-gray-300 rounded-r-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                        </div>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">Merchant
                                            Address</label>
                                        <div class="flex">
                                            <span
                                                class="inline-flex items-center px-3 py-2 rounded-l-md border border-r-0 border-gray-300 bg-gray-50 text-gray-500 text-sm">
                                            ...
                                            <input value="{{ $detail->merchant_address }}" type="text"
                                            ...
                                            <div class="flex items-center space-x-3">
                                                <label class="flex-1">
                                                    <div
                                                        ...
                                                        <p class="upload-text text-sm text-gray-500 mt-2">Click to Reupload
                                                        </p>
