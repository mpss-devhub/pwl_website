                            ...
                            <div class="flex flex-col lg:flex-row gap-4 items-start sm:mt-2">
                                ...
                                <div class="mt-1 space-y-2 mt-3">
                                    <div class="grid grid-cols-2 gap-x-20">
                                        ...
                                        <span
                                            class="text-xs  text-gray-900 text-right">{{ $merchant['merchant_name'] }}</span>
                                    </div>
                                    <div class="grid grid-cols-2 gap-x-20">
                                    ...
                                    <div class="grid grid-cols-2 gap-x-20">
                                        ...
                                        <span
                                            class="text-xs  text-gray-900 text-right ">{{ $merchant['created_at']->format('Y-M-D') }}</span>
                                    </div>
                                </div>
                            </div>

                            <!-- Right Section -->
                            <div class="flex flex-col gap-2 sm:mt-2">
