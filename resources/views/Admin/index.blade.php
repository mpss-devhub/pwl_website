    ...
    <div class="p-4 rounded-lg mt-14">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-3">
                <button class="px-4 py-2 bg-white border border-gray-200 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50">
                    Export Report
                </button>
            ...
            <div class="bg-white p-5 rounded-lg shadow border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="flex ">
                            <p class="text-2xl font-semibold text-gray-800"> 5561289456  </p><small class="text-muted text-gray-500 mt-2 mx-1">MMK</small>
                        </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow border border-gray-100">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div class="flex space-x-2">
                        ...
                        <button class="px-3 py-1 text-xs bg-white border border-gray-200 text-gray-600 rounded-md">Month</button>
                        <button class="px-3 py-1 text-xs bg-white border border-gray-200 text-gray-600 rounded-md">Week</button>
                    </div>
                </div>
                <div class="h-80">
