        ...
        <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('admin.links') }}"
                        ...
                        <i class="fa-solid fa-shield-halved text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true"></i>
                        <span class="flex-1 ms-3 whitespace-nowrap">Links History</span>
            ...
            <li>
                <a href="{{ route('admin.settlement') }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Settlement</span>
            ...
            @if (in_array('M', $per))
                <li>
                    <a href="{{ route('merchant.show') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Our Merchant</span>
                    </a>
                </li>
            @endif
            ...
            @if (in_array('U', $per))
                <li>
                    <a href="{{ route('user.show') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Admin Users</span>
                    </a>
                </li>
            @endif
            @if (in_array('AA', $per))
                <li>
                    <a href="{{ route('access.show') }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <i class="fa-solid fa-universal-access text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true"></i>
            ...
            @if (in_array('S', $per))
                <li>
                    <a href="{{ route('support.list') }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <i class="fa-solid fa-headset text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true"></i>
