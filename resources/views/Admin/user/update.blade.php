                    ...
                    <div class="p-6">
                        ...
                        <form action="{{ route('user.update', $user->id) }}" method="POST" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <!-- Created At -->
                                <div>
                                    <label for="created_at" class="block text-sm font-medium text-gray-700 mb-1">Created
                                        At</label>
                            ...
                            <div class="flex justify-end space-x-4 pt-4 border-t border-gray-200">
                                ...
                                <button type="submit"
                                    class="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-600 hover:bg-gray-700 focus:outline-none focus:ring-1 focus:ring-gray-500">
                                    Update User Info
                                </button>
                            </div>
                        </form>
